        ...
        JPermissionActivity.permissionRequest(context, permission.value(), permission.requestCode(), new IPermission() {
            ...
            public void denied(int requestCode, List<String> denyList) {
                ...
                for (Method method : methods) {
                    ...
                    boolean isHasAnnotation =/* method.isAnnotationPresent(PermissionDenied.class)*/false;
                    if (isHasAnnotation) {
            ...
            public void canceled(int requestCode) {
                ...
                for (Method method : methods) {
                    ...
                    boolean isHasAnnotation =/* method.isAnnotationPresent(PermissionCanceled.class)*/false;
                    if (isHasAnnotation) {
                        method.setAccessible(true);
